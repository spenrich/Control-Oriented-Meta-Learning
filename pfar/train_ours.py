"""
Train an adaptable PFAR dynamics model via control-oriented meta-learning.
...
from utils.ode import odeint_fixed_step, rk38_step
from utils.params import epoch, params_to_cholesky, params_to_posdef
...
if __name__ == '__main__':
    ...
    output_path = os.path.join('pfar', 'models', 'ours', output_name + '.pkl')
