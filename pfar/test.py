...
from utils.dynamics import disturbance, plant, prior
from utils.params import params_to_posdef
...
hparams = {
    ...
    'w_max': 9.,    # maximum wind velocity in inertial `x`-direction
...
if __name__ == '__main__':
    ...
    filename = os.path.join('pfar', 'models', 'ours',
