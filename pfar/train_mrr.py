"""
Train an adaptable PFAR dynamics model via meta-ridge regression (MRR).
...
from utils.dynamics import prior
...
if __name__ == '__main__':
    ...
    path = os.path.join('pfar', 'training_data.pkl')
    ...
    def lstsq_coefs(params, t, x, u, t_next, x_next, prior=prior):
        """Compute the coefficients of the least-squares objective."""
        num_dof = x.size // 2
    ...
    def trajectory_loss(params, key, num_ridge_samples, regularizer_ridge,
                        t, x, u, t_next, x_next):
        """Compute the loss over one trajectory."""
    ...
    def loss(params, regularizer_l2, keys, num_ridge_samples,
        ...
        """Compute the total loss over a batch of data."""
    ...
    output_path = os.path.join('pfar', 'models', 'mrr', output_name + '.pkl')
